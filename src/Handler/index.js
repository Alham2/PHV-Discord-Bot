...
module.exports = async (client) => {
    ...
    client.on('ready', async () => {
        // Set the Slash Commands to reply with a development message
        const developmentMessage = 'This command is currently under development. Please do not use it.';
        client.on('interactionCreate', (interaction) => {
            if (interaction.isCommand() && interaction.commandName === 'tweet') {
                interaction.reply(developmentMessage);
            }
        });
